                            ...
                            <form class="form-horizontal form-bordered" role="form" method="POST" action="add_reg_mem.php" >
                                 <div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
                                        ...
                                        <select class="form-control" name="eventId" data-parsley-required="true"placeholder="Gender">
                                        <option></option>
                                                                  <?php
                                                                        $view_query = mysqli_query($connection,"SELECT * FROM `ems_r_event`");
                            ...
                            <form class="form-horizontal form-bordered" role="form" method="POST" action="add_reg_nonmem.php" >
                                 <div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
                                        ...
                                        <select class="form-control" name="nmr_event_id" data-parsley-required="true"placeholder="Gender">
                                        <option></option>
                                                                  <?php
                                                                        $view_query = mysqli_query($connection,"SELECT * FROM `ems_r_event`");
                                                                        while($row = mysqli_fetch_assoc($view_query))
