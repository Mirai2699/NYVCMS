...
?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Sponsor Type</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Sponsor Type</h1>
			<!-- end page-header -->
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
			    	<p>
						<td><a href="ui_modal_notification.html#modal-dialog" class="btn btn-sm btn-success" data-toggle="modal">Add Sponsor Type</a></td>
			    	</p>
			    	<!-- #modal-dialog -->
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title">Add Sponsor Type</h4>
										</div>
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    	...
                                    	<?php
                                    		...
                                    		$query = "SELECT DISTINCT * FROM ems_r_sponsor_type WHERE rst_stype_status = 1";

                                    		$runquery = mysqli_query($connection, $query);

                                    		while ($row = mysqli_fetch_assoc($runquery)){

                                    			$data_stype = $row['rst_stype_name'];
                                    			$datastypeid = $row['rst_stype_id'];
    ...
    <script type="text/javascript">
    	...
    	function btn_upeventype(myId){
    		...
    		$.ajax({
    			type: 'POST',
    			url:'../functionalities/update_sponsor_type.php',
    			async: false,
    			data:{
