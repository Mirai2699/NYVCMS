			...
			<div class="row">
			    ...
			    <div class="col-md-12">
					<ul class="nav nav-tabs">
						<li class="active"><a href="ui_tabs_accordions.html#default-tab-1" data-toggle="tab">Membership (Individual)</a></li>
						<li class=""><a href="ui_tabs_accordions.html#default-tab-2" data-toggle="tab">Membership (Organization)</a></li>
						<li class=""><a href="ui_tabs_accordions.html#default-tab-3" data-toggle="tab">Renewal (Individual)</a></li>
						<li class=""><a href="ui_tabs_accordions.html#default-tab-4" data-toggle="tab">Renewal (Organization</a></li>
						<!-- <li class=""><a href="ui_tabs_accordions.html#default-tab-5" data-toggle="tab">Event Registration (Member)</a></li>
						<li class=""><a href="ui_tabs_accordions.html#default-tab-6" data-toggle="tab">Event Registration (Non-member)</a></li> -->
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="default-tab-3">
								<ul class="nav nav-pills">
								<li class="active"><a href="ui_tabs_accordions.html#nav-pills-tab-111" data-toggle="tab">Bank</a></li>
																	                                ...
																	                                <div class='form-group'>
																	                                    ...
																	                                    <div class='col-md-9'>
																	                                    	<div class='input-group input-daterange'>
																	                                            <input type='text' id='renindivdate' class='form-control' placeholder='Date of Payment' />
																	                                        </div>
						...
						<div class="tab-pane fade" id="default-tab-4">
							<ul class="nav nav-pills">
								<li class="active"><a href="ui_tabs_accordions.html#nav-pills-tab-1112" data-toggle="tab">Bank</a></li>
								<li><a href="ui_tabs_accordions.html#nav-pills-tab-2223" data-toggle="tab">Paid</a></li>
							</ul>
								<div class="tab-content">
									<div class="tab-pane fade active in" id="nav-pills-tab-112">
									    <h3 class="m-t-10">Bank</h3>
										<!-- begin panel -->
					                    <div class="panel panel-inverse">
					                        <div class="panel-body">
																							...
																							<div class='panel-body'>
																	                            <form class='form-horizontal'>
																	                                ...
																	                                <div class='form-group'>
																	                                    ...
																	                                    <div class='col-md-9'>
																	                                    	<div class='input-group input-daterange'>
																	                                            <input type='text' id='renorgdate' class='form-control' placeholder='Date of Payment' />
																	                                        </div>
									...
									<div class="tab-pane fade" id="nav-pills-tab-2223">
									    <h3 class="m-t-10">Paid</h3>
										<!-- begin panel -->
					                    <div class="panel panel-inverse">
					                        <div class="panel-body">
