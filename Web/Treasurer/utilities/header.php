...
session_start();
    ...
    if(!isset($_SESSION['UserName']) && $type!="4"){
...
<head>
	...
	<link href="../../../resources/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet" />
	<link href="../../../resources/assets/plugins/jquery-tag-it/css/jquery.tagit.css" rel="stylesheet" />
