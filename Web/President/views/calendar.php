...
<head>
	<meta charset="utf-8" />
	<title>NYVCEMS | Blank Page</title>
	...
	<link href="../../../resources/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
...
<body>
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="event-setup.php">Event Setup</a></li>
							<li><a href="activity-setup.php">Activity Setup</a></li>
	...
	<script src="../../../resources/assets/plugins/fullcalendar/fullcalendar/fullcalendar.js"></script>
	<script src="../../../resources/assets/js/calendar.demo.min.js"></script>
	<script src="../../../resources/assets/plugins/gritter/js/jquery.gritter.js"></script>
	<script src="../../../resources/assets/js/ui-modal-notification.demo.min.js"></script>
