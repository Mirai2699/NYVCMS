											...
											<div class="panel-body">
					                            <form class="form-horizontal">
					                                ...
					                                <div class="form-group">
					                                    ...
					                                    <div class="col-md-9">
					                                        <input type="text" id="txt_budget" class="form-control" placeholder="00.00"/>
					                                    </div>
					                                </div>
					                            </form>
					                        </div>
                                    		...
                                    		while ($row = mysqli_fetch_assoc($runquery)){
                                    			...
                                    			echo "<tr>
                                    					...
                                    					<td style='width:135px'>
			                                            	...
			                                            	<a href='javascript:;' onclick='btn_userrole(".$dataeventid.")' class='btn btn-danger' data-toggle='modal'><i class='fa fa-times'></i></a>
			                                            </td>
                                    				  </tr>
