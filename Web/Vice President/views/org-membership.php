							...
							<table id="data-table" class="table table-striped table-bordered">
	                            ...
	                            <tbody>
	                            	...
	                            	<?php
	                            		...
	                            		$query = "SELECT * FROM ems_t_org_membership AS M  INNER JOIN ems_r_org_info AS I ON M.tom_orgid = I.roi_orgid WHERE M.tom_status = 'Paid' AND M.tom_activeflag = 0";
...
";
    ...
    <script type="text/javascript">
    	...
    	function btn_inactive(myId){
    		...
    		$.ajax({
    			type: 'POST',
    			url:'../functionalities/inactive-org.php',
    			async: false,
    			data:{
    					_myId:myId
    			},
    	...
    	function btn_renewal(myId){
    		...
    		$.ajax({
    			type: 'POST',
    			url:'../functionalities/active-org.php',
    			async: false,
    			data:{
    					_date:date,
    					_myId:myId
