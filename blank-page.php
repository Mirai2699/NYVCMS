	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="ui_general.html">Event Setup</a></li>
							<li><a href="ui_typography.html">Activity Setup</a></li>
							<li><a href="ui_tabs_accordions.html">Sponsor</a></li>
							<li><a href="ui_modal_notification.html">Logistics</a></li>
						</ul>
					</li>
        ...
        <div class="theme-panel">
            ...
            <div class="theme-panel-content">
                ...
                <div class="row m-t-10">
                    <div class="col-md-12">
                        <a href="calendar.html#" class="btn btn-inverse btn-block btn-sm" data-click="reset-local-storage"><i class="fa fa-refresh m-r-3"></i> Reset Local Storage</a>
                    </div>
                </div>
            </div>
        </div>
